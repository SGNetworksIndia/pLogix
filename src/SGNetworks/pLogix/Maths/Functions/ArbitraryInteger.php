...
namespace SGNetworks\pLogix\Maths\Functions;
...
class ArbitraryInteger {
	 ...
	 */
	public static function ackermann(Number\ArbitraryInteger|int|string $m, Number\ArbitraryInteger|int|string $n): Number\ArbitraryInteger {
