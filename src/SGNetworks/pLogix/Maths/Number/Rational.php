...
class Rational implements ObjectArithmetic {
	 ...
	 * Subtraction
	 *
	 * @param int|Rational $object_or_scalar
	 *
	 * @return Rational
	 *
	 * @throws Exception\IncorrectTypeException if the argument is not numeric or Rational.
	 */
	public function subtract(int|Rational $object_or_scalar): Rational {
		if(\is_int($object_or_scalar)) {
	 ...
	 * @throws Exception\IncorrectTypeException if the argument is not numeric or Rational.
	 */
	public function multiply(int|Rational $object_or_scalar): Rational {
		if(\is_int($object_or_scalar)) {
	 ...
	 * @throws Exception\IncorrectTypeException if the argument is not numeric or Rational.
	 */
	public function divide(int|Rational $r): Rational {
		if(\is_int($r)) {
